              ...
              <li class="nav-item"><a class="nav-link" href="login.php">Communication</a></li>
               <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="blogPost.php">Add Post</a></li>
    ...
    <?php
    	...
    	if ($POST_QUERY = mysqli_num_rows($results) > 0) {
    		while ($POSTS = mysqli_fetch_assoc($results)) {
    			...
    			$blogtitle = $POSTS['blogtitle'];
         		$blogdescription = $POSTS['blogdescription'];
          		...
          		?>
			    	...
			    	<div>
			    		<p><img src=<?php echo $blogimage;?> style=" width: 250px; height: 200px;"></p>
			    		...
			    		<div class="col-lg-7 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
			    			...
			    			<div class="detials">
			    				<form>
			    			<div class="detials"><a href=blogView.php?postID=<?php echo $postID?>>VIEW</a></div>
			    		</form>
			    			</div>
                <div class="detials">
                  -
                ...
                <div class="detials">
                  <form>
                <div class="detials"><a href=blogEdit.php?postID=<?php echo $postID?>>EDIT</a></div>
              </form>
              </div>
              <div class="detials">
                -
              ...
              <div class="detials">
                <form>
                <div class="detials">
                  <a href=blogView.php?postID=<?php echo $postID?>>COMMENT</a>
                </div>
              </form>
              </div>
			    			<?php else: ?>
