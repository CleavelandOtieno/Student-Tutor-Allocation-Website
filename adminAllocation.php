...
$query = "
	SELECT userName FROM regstudent GROUP BY userName ORDER BY userName ASC
";
$statement = $connect->prepare($query);
...
$query = "
	SELECT emailAddress FROM regstudent GROUP BY emailAddress ORDER BY emailAddress ASC
";
$statement = $connect->prepare($query);
...
foreach($result as $row)
{
	$emailAddress .= '<option value="'.$row["emailAddress"].'">'.$row["emailAddress"].'</option>';
}
...
<head>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item active"><a class="nav-link" href="adminAllocation1.php">Bulk Allocation</a></li>
						</ul>
					</div>
				</div>
			</nav>
	...
	<!--================ End Header Menu Area =================-->
		...
		<div class="container" style="width:600px;">
			<h2 align="center">SINGLE ALLOCATION</h2><br /><br />
			<form method="post" id="insert_data" >
				...
				<select name="temail" id="temail" class="form-control action">
					<option value="">Tutor Email Address</option>
					<?php echo $email; ?>
				</select>
				<br />
				<select name="suname" id="suname" class="form-control action">
					<option value="">Select Student UserName</option>
					<?php echo $userName; ?>
				</select>
				<br />
				<select name="semail" id="semail" class="form-control action">
					<option value="">Student Email Address</option>
...
$(document).ready(function(){
	$('#insert_data').on('submit', function(event){
		...
		{
			alert("Please Select tutor emailAddress");
			return false;
		}
		else if($('#suname').val() == '')
		{
		...
		{
			alert("Please Select student emailAddress");
			return false;
		}
		else
		{
